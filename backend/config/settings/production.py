...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["naggingnelly.freedman.io"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="backend <noreply@naggingnelly.freedman.io>"
)
